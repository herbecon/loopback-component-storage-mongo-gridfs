 ...
 * Download middleware for the HTTP request.
 */
GridFSService.prototype.downloadInlineFileId = function (fileId, res, cb) {
  var self = this;
 ...
 */
GridFSService.prototype.downloadInlineFileId.shared = true;
GridFSService.prototype.downloadInlineFileId.accepts = [
  { arg: 'fileId', type: 'string', description: 'File id' },
  { arg: 'res', type: 'object', 'http': { source: 'res' } }
];
GridFSService.prototype.downloadInlineFileId.http = {
  verb: 'get',
  path: '/downloadInlineFileId/:fileId'
};